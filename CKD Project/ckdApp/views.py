...
class dataUploadView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            data_s=request.POST.get('sex')
            data_b=request.POST.get('bmi')
            data_ch=request.POST.get('children')
            data_sm=request.POST.get('smoker')
            #print (data)
            ...
            data = np.array([data_a,data_s,data_b,data_ch,data_sm])
            #sc = StandardScaler()
...
#data_for_prediction =obj.pca(np.array(data_for_prediction),y_test)
            ...
            return render(request, "succ_msg.html", {'data_a':data_a,'data_s':data_s,'data_b':data_b,'data_ch':data_ch,'data_sm':data_sm,
                                                        'out':out})
